        ...
        <>
            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                <img
                    ...
                    src="https://media.istockphoto.com/id/1415621839/video/music-cd-collection-at-home.jpg?s=640x640&k=20&c=Plqo5emNoEwuKk5GuRSux-4diRrsiuoRAj9SkZJSoEg="
                />
                <div
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end">
                                {auth.user ? (
                                    ...
                                    <>
                                        <Link
                                            href={route('login')}
                                            className="rounded-md px-3 py-2 text-blue-500 text-lg ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                        >
                                            Log in
                                        </Link>
                                        <Link
